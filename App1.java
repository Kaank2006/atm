...
public class App1 {
            ...
            try {
                ...
                switch (job) {
                    case "1" -> {
                        ...
                        //  If client exists
                        else if (checkClientExist(Integer.parseInt(ClientID)) != 0) {
                            ...
                            while (signup) {
                                ...
                                if (answer.equals("yes")) {
                                    ...
                                    System.out.println("Please enter your your surname.");
                                    surname = reader.readLine();
                                    System.out.println("please enter the city you live.");
                                    city = reader.readLine();
                                    int newClient = connector.createClient(name, surname, city);
                                    System.out.printf("Client created! welcome %s %s, Client ID:%s\n", name, surname, newClient);
                                    iniext = false;
                                    signup = false;
    ...
    public static int checkClientExist(int clientID){
        Connector connector = new Connector();
        int returnID = 0;
